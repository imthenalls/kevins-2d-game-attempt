...
namespace Game.Core
{
    ...
    public float playerOffsetY;
        ...
        public List<QuestSaveEntry> activeQuests = new();
...
public class WorldPositionSaveEntry
{
    ...
    public class NpcSaveEntry
    {
        ...
        // Pure-model NPCs (NpcStateView) persist the logical grid cell here; hp/maxHp above carry the
        // model's health. Stable npcId + ordinary values only, no scene references.
        public bool hasModelState;
        public int  cellX;
        public int  cellY;
