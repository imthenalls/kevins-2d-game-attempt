...
public abstract class NpcBehaviorBase : MonoBehaviour, INpcBehavior
{
    ...
    [SerializeField] private NpcBehaviorConfig config = new NpcBehaviorConfig();

    [Header("Unity References")]
    [SerializeField] protected SpriteRenderer spriteRenderer;

    /// <summary>Game.Data tuning for this behavior.</summary>
    protected NpcBehaviorConfig Config => config;
