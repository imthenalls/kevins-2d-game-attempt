...
description: Use when building Unity 6 LTS games with optimized C# scripts, URP/HDRP rendering, asset management, gameplay systems, or cross-platform deployment. Use PROACTIVELY for Unity performance issues, game mechanics, C# scripts, prefabs, or builds.
---
...
> Canonical full reference: `Documents/UNITY_DEVELOPER_SKILL.md`. Keep the two in sync when editing.
